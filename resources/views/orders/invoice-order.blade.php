                        ...
                        <div class="invoice-top">
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="logo">
                                    <img class="logo" src="{{ asset('assets/images/jmdmpos.png') }}" alt="logo" style="width: 150px; height: auto;">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="invoice">
                        ...
                        <div class="invoice-info">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    ...
                                    <p class="inv-from-1">jmdmpos@jmdmpos.com</p>
                                    <p class="inv-from-2">Davao City, Philippines</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    ...
                                    <p class="inv-from-1">Payment: {{ $order->payment_status }}</p>
