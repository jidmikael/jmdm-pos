...
<style>
    body {
        background-image: url("{{ asset('assets/images/1234.jpg') }}");
...
<div class="container">
    <div class="row align-items-center justify-content-center height-self-center">
        <div class="col-lg-8">
        <div class="card auth-card" style="background-color:rgb(255, 255, 255);">
                    ...
                    <div class="d-flex align-items-center auth-content">
                        <div class="col-lg-7 align-self-center">
                            <div class="p-3">
                                ...
                                <p>Create your JMDMPOS account.</p>
                        ...
                        <div class="col-lg-5 content-right">
                            <img src="{{ asset('assets/images/jmdmpos.png') }}" class="img-fluid image-right" alt="">
                        </div>
                    </div>
                </div>
            </div>
