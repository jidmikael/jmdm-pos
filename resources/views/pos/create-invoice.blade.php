            ...
            <div class="card card-block">
                <div class="card-header d-flex justify-content-between bg-primary">
                    ...
                    <div class="invoice-btn d-flex">
                        ...
                        <button type="button" class="btn btn-primary-dark mr-2" data-toggle="modal" data-target=".bd-example-modal-lg">Payment</button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('pay') is-invalid @enderror" id="pay" name="pay" value="{{ Cart::total() }}" readonly>
                                                    @error('pay')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
