...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('products.index', [
            'products' => Product::visible()->with(['category', 'supplier'])
    ...
    public function destroy(Product $product)
    {
        ...
        return Redirect::route('products.index')->with('success', 'Product has been archived!');
    }
    ...
    public function archived()
    {
        ...
        $archivedProducts = Product::where('hidden', true)
    ...
    public function restore(Product $product)
    {
        ...
        return redirect()->route('products.archived')->with('success', 'Product has been restored!');
    }
